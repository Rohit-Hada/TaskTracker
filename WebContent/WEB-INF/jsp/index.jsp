		    ...
		    <script type="text/javascript">
			 ...
			 <div class="bg"> 
				   ...
				   <form class="form-horizontal" action="login" method="post">
				    ...
				    <div class="form-group"> 
				      <div class="col-sm-offset-4 col-sm-8">
				        ...
				        <button type="submit" class="btn btn-success" style="width: 50%; center: 30%;">Login</button>
				      </div>
				          <div class="col-sm-offset-4 col-sm-8"> 
				          <a style="color:white" href="/TaskTracker/userRegistration">Register New User</a>
				         </div>  
				    </div>
				  </form>
			 </div>
			  ...
			  <footer class="footer navbar-fixed-bottom">
			    <!-- Copyright -->
			    <div class="footer-copyright text-center py-3 "style="color:white;background-color:rgb(34, 29, 29);font-size:110%;padding:1%;"> 2024 Copyright
